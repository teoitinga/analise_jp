...
colnames(coverage) <- c("ANO", "Formacao_Florestal", "Plantacao_Florestal", "Plantacao_Florestal" , "Rio_Lago_Mar", "Infraestrutura_Urbana" )
coverage
```
...
chart6 <- ggplot(dataset, aes(x=ANO, y=WATER_COVERAGE_HA)) + geom_point(color='darkblue', size=2) +
        ...
        subtitle =
        "Relação de superfície de água no decorrer da série histórica",
